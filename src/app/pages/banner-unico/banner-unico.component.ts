...
@Component({
  selector: 'app-banner-unico',
  templateUrl: './banner-unico.component.html',
  styleUrls: ['./banner-unico.component.scss']
})
export class BannerUnicoComponent implements OnInit {
  id: any;
  post: any;
  install = false;
  pdfSrc;
