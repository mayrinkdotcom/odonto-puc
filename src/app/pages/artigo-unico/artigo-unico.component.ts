...
@Component({
  selector: 'app-artigo-unico',
  templateUrl: './artigo-unico.component.html',
  styleUrls: ['./artigo-unico.component.scss']
})
export class ArtigoUnicoComponent implements OnInit {
  id: any;
  post: any;
  install = false;
  pdfSrc;
